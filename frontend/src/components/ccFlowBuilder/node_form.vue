<template>
  <div class="q-pa-md">
    <div class="row justify-between items-center q-mb-md tw-gap-2">
      <q-btn
        rounded
        color="primary"
        icon="mdi-plus"
    ...
    <q-card
      ...
      class="tw-rounded-lg"
    >
      <div class="ef-node-form-header tw-flex tw-items-center tw-gap-1.5">
        <q-icon
          ...
          >
            ...
            >
              <div class="text-center ">
                ...
                <div
                  class="row bg-grey-3 q-pa-sm q-my-md justify-center tw-rounded-md"
                >
                  <div class="col-xs-12">
                    <div
            ...
            >
              <div v-show="type === 'node'">
                ...
                <div
                  class="row bg-grey-3 q-pa-sm q-mt-md col justify-start tw-rounded-md"
                >
      ...
      <q-card-section
        class="row bg-grey-3 q-pa-sm col justify-start tw-gap-2"
      ...
      >
        ...
        >
          <div class="full-width bg-grey-3 text-bold row col justify-between text-left q-pa-md">
            ...
            <div class="row text-subtitle2">
              Quando o bot direcionar o atendimento para um setor ou usuário,
        ...
        >
          <div class="full-width bg-grey-3 text-bold text-body1 row col justify-between text-left q-pa-md">
            ...
            <div class="row text-subtitle2">
              Não: Desativado. <br />
              Balancear: Definirá o usuário com base na quantidade de atendimentos de cada usuário do setor. Usuário com
              menos atendimentos será escolhido.<br />
              Aleatória: Definirá o usuário de forma aleatória/randômica para os usuários do setor.
            </div>
          </div>
          <q-card-section class="q-pa-sm">
            <div class="row q-mt-sm">
      ...
      <q-card-section
        class="row bg-grey-3 q-pa-sm col justify-start"
