    ...
    >
      <template v-slot:top>
        <div class="row items-center justify-between full-width">
          <div>
            <div class="tw-text-lg tw-font-bold tw-text-foreground">Mensagens Rápidas</div>
            <div class="tw-text-sm tw-text-muted-foreground">Respostas prontas acionadas digitando "/" no chat</div>
          </div>
          <q-btn
            color="primary"
            label="Adicionar"
