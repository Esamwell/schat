      ...
      <template v-slot:top>
        <div class="row items-center full-width q-gutter-sm">
          <div class="col-12 col-sm-auto q-mr-md">
            <div class="tw-text-lg tw-font-bold tw-text-foreground">Usuários</div>
            <div class="tw-text-sm tw-text-muted-foreground">Contas de atendentes e administradores</div>
          </div>
          <q-input
            style="width: 300px"
            outlined
