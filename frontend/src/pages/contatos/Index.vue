<template>
  <div>
    ...
    >
      <template v-slot:top>
        <div class="row col-2 q-table__title items-center tw-font-bold tw-text-foreground">
          <q-btn
            v-if="isChatContact"
            class="q-mr-sm"
            color="dark"
        ...
        >
          <q-list separator>
            ...
            >
              <q-item-section>
                <q-item-label>Baixar Planilha Exemplo</q-item-label>
              </q-item-section>
            </q-item>
            <q-item
              clickable
      ...
      <template v-slot:body-cell-profilePicUrl="props">
        <q-td>
          <q-avatar style="border: 1px solid #E2E8F0 !important">
            <q-icon
              name="mdi-account"
              size="1.5em"
              color="grey-5"
...
export default {
  ...
  methods: {
    downloadExampleCSV () {
      const csvContent = 'Nome;Numero\nExemplo 1;5511999999999\nExemplo 2;5511888888888'
