  ...
  <div>
    <q-card class="q-ma-md">
      <q-card-section class="row items-center justify-between">
        <div>
          <div class="tw-text-lg tw-font-bold tw-text-foreground">Configurações API</div>
          <div class="tw-text-sm tw-text-muted-foreground">Conecte o SChat a outros sistemas via webhook</div>
        </div>
        <q-btn
          color="primary"
          rounded
