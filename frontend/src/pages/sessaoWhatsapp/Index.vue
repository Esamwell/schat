    ...
    <div class="row col full-width q-pa-sm">
      ...
      >
        <q-card-section class="row items-center justify-between q-pa-md">
          <div>
            <div class="tw-text-lg tw-font-bold tw-text-foreground">Canais</div>
            <div class="tw-text-sm tw-text-muted-foreground">Conecte e gerencie seus canais de comunicação</div>
          </div>
          <q-btn
            rounded
            color="primary"
      ...
      <template v-for="item in canais">
        ...
        >
          <q-card-section class="row items-center no-wrap q-gutter-sm">
            ...
            <div class="col">
              <div class="tw-text-base tw-font-bold tw-text-foreground">{{ item.name }}</div>
              <div class="tw-text-xs tw-text-muted-foreground tw-capitalize">{{ item.type }}</div>
            </div>
            <q-btn
              round
              flat
