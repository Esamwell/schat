    ...
    >
      <template v-slot:top>
        <div class="row items-center justify-between full-width">
          <div>
            <div class="tw-text-lg tw-font-bold tw-text-foreground">Etiquetas</div>
            <div class="tw-text-sm tw-text-muted-foreground">Categorize contatos e filtre campanhas e relatórios</div>
          </div>
          <q-btn
            color="primary"
            label="Adicionar"
